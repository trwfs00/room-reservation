...
export default function list() {
    ...
    const formatTimestampToLocaleDate = (t) => {
        console.log(t)
        const newTimestamp = new Date(t);
        return newTimestamp
    }
        ...
        <div className="bg-white font-ibm py-2">
            ...
            <div className="mx-auto flex flex-col max-w-7xl items-center justify-center p-6 lg:px-8 pb-16">
                <div className="flex flex-col sm:flex-row justify-between items-center w-full max-w-4xl my-4">
                    <h1 className="text-2xl font-semibold">รายงานการจองห้อง</h1>
                                ...
                                <>
                                    {displayedList.map((booking) => (
                                        <tr className="bg-white border-b" key={booking._id}>
                                            ...
                                            <td className="px-6 py-4 font-medium">
                                                {formatDateToThaiLocale(booking.createdAt)}
                                            </td>
                                        </tr>
                                    ))
                                    }
                ...
                <div className="mt-4 flex justify-center">
                    ...
                    <button
                        ...
                        className={`px-4 py-2 mx-2 rounded-md ` + (endIndex+1 <= list.length ? `bg-[#3E99EC] text-white` : `bg-gray-200 text-gray-900`)}
                    >
                        ต่อไป
                    </button>
                </div>
